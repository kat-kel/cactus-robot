...
## Quick test
With the requirements installed in a virtual environment (`pip install -r requirements.txt`) and the [médialab's version of xsv](https://github.com/medialab/xsv), you can quickly see this program in action using the example dataset downloaded with this repository.
```shell
